...
//+
Physical Surface("bottomchannel") = {5};
//+
Physical Curve("topconnector") = {2, 6};
//+
Physical Curve("topcon") = {7};
//+
Physical Curve("bottomconnector") = {16, 14};
//+
Physical Curve("bottomcon") = {15};
//+
Physical Curve("topmiddle") = {9};
//+
Physical Curve("bottommiddle") = {11};
