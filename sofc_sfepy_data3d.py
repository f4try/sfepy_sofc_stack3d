...
ebcs = {
    ...
    'Topmiddle': ('Omega_Surface_TS2', {'phil.0': 0.0}),
...
equations = {
    '2': """%.12e *dw_volume_dot.i.Omega( s, dT/dt )
            ...
            =-dw_electric_source.i.Omega_top( m.DH,s, phis1 )-dw_electric_source.i.Omega_middle( m.DH,
                                           ...
                                           +dw_bc_newton.2.Omega_Surface_B1(m.h,m.T0,s,T)""" % specific_heat,
    'eq1': """dw_laplace.i.Omega_cell( m.electroyle_conductivity, psil, phil ) 
           = dw_surface_integrate.i.Omega_Surface_TS2(m.i0,psil)
           -dw_surface_integrate.i.Omega_Surface_BS1(m.i0,psil)""",
    'eq2': """dw_laplace.i.Omega_top( m.electric_conductivity, psis1, phis1 ) 
           = dw_surface_integrate.i.Omega_Surface_TS1(m.i0,psis1)""",
    'eq3': """dw_laplace.i.Omega_bottom( m.electric_conductivity, psis3, phis3 ) 
